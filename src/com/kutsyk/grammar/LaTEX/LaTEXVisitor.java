...
public interface LaTEXVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link LaTEXParser#authorItemMiss}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitAuthorItemMiss(@NotNull LaTEXParser.AuthorItemMissContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link LaTEXParser#newCommandList}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitNewCommandList(@NotNull LaTEXParser.NewCommandListContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link LaTEXParser#colon}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitColon(@NotNull LaTEXParser.ColonContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link LaTEXParser#startingDeclaration}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitStartingDeclaration(@NotNull LaTEXParser.StartingDeclarationContext ctx);
	/**
